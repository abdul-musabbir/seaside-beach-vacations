...
function HeroSection() {
    return (
        ...
        <div className="absolute inset-0 opacity-30 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTQ0MCIgaGVpZ2h0PSIxMjAwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjxwYXRoIGQ9Ik0wIDBoMTQ0MHY4MDBTMTEyMCA2NDAgNzIwIDY0MCAzNjAgODAwIDM2MCA4MDBIMFYweiIgZmlsbD0iIzAwMCIvPjwvc3ZnPg==')] animate-wave"></div>
            ...
            {/* Main Content */}
            <div className="w-11/12 xl:max-w-screen-xl flex mx-auto px-4 relative z-10">
            ...
            <span className="text-white/90 text-sm font-medium">
              Premium Beachfront Experience
                    ...
                    <h1 className="text-3xl sm:text-5xl sm:mb-56 md:text-[50px] md:leading-[50px] md:mb-72 lg:text-7xl font-bold mb-6 leading-tight animate-fade-in lg:mb-56">
                    ...
                    {/* Enhanced Subtitle */}
                    <div className="lg:relative sm:relative sm:top-8 lg:top-24">
            ...
            <span className="text-white/90 font-medium">
              Three Houses from Seaside Park's Pristine Beach
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between md:flex-row md:justify-between lg:flex-row lg:w-full lg:justify-between gap-6 justify-center items-center mb-20">
                        <a
                            href={"#featured-tours"}
                            className="group bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all transform hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-500/20 flex items-center"
                        >
                            Book Now
                        ...
                        <a
                            href="#contact-us"
                            className="group bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all transform hover:scale-[1.02] hover:shadow-xl hover:shadow-white/10 flex items-center border border-white/20"
                        >
                            Contact US
                            <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                        </a>
