            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="grid grid-cols-2 gap-4 relative">
                    <div className="col-span-2 ">
                        <img
                            src="https://seasidebeachvacations.com/storage/public/beach-escape/1.jpg"
                            alt="Temple view"
                    ...
                    <div>
                        <img
                            src="https://seasidebeachvacations.com/storage/public/ocean-oasis/1.jpg"
                    ...
                    <div>
                        <img
                            src="https://seasidebeachvacations.com/storage/public/unit-1/1.jpg"
                            alt="Adventure jeep"
                            className="w-full h-48 object-cover rounded-lg"
                        />
                    </div>
